...
현재 `main`에는 Phase 1·1.5의 자연 스폰 성장 확장과 슬라임 개체 저장 모델이
반영되어 있습니다. Unity Editor와 Android 개발 빌드에서 게임 시작, 로그인,
업그레이드, 튜토리얼, 재실행 후 데이터 복원과 Firestore 스키마 저장을
확인했습니다. Release 빌드 및 Play Console 검증은 아직 수행하지 않았습니다.

다음 개발 단계는 같은 GameScene 안에 세 번째 공간으로 추가하는 Phase 2
장식장입니다.
